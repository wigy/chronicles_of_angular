describe('module coa.data, TypeStr class', function() {
    ...
    it('refuses to initialize undefined values', function() {
        ...
        expect(d.errors()).toEqual(['Invalid value undefined for member of type TypeStr({default: "default name", label: "Name of the team", pattern: null, required: false}) for object Data({name: "default name"})']);
